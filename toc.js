...
onLoad(function() { // Anonymous function defines a local scope
    ...
    if (!toc) {
        ...
        toc.id = "TOC";
        document.body.insertBefore(toc, document.body.firstChild); //insert JS_Definite_Guide before body.firstChild
    }
    ...
    function findHeadings(root, sects) {
        for(var c = root.firstChild; c != null; c = c.nextSibling) {
            ...
            if (c.tagName.length == 2 && c.tagName.charAt(0) == "H") //match H1,H2, ...
                sects.push(c);
            else 
